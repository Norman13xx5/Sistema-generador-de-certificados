...
class Categoria extends Conectar
{
    ...
    public function insertar_categoria($id_categoria, $nombre_curso, $descripcion_curso, $fecha_inicio_curso, $fecha_final_curso, $id_instrutor)
    {
    ...
    public function update_categoria($id_curso, $id_categoria, $nombre_curso, $descripcion_curso, $fecha_inicio_curso, $fecha_final_curso, $id_instrutor)
    {
        $conectar = parent::conexion();
        parent::set_name();
        $sql = "UPDATE tm_curso
    ...
    public function delete_categoria($id_curso)
    {
        $conectar = parent::conexion();
        parent::set_name();
        $sql = "UPDATE tm_curso
    ...
    public function get_categoria_id($id_curso)
    {
        $conectar = parent::conexion();
        parent::set_name();
