...
class Instructor extends Conectar
{
    ...
    public function insertar_instructor($id_categoria, $nombre_curso, $descripcion_curso, $fecha_inicio_curso, $fecha_final_curso, $id_instrutor)
    {
    ...
    public function update_instructor($id_curso, $id_categoria, $nombre_curso, $descripcion_curso, $fecha_inicio_curso, $fecha_final_curso, $id_instrutor)
    {
        $conectar = parent::conexion();
        parent::set_name();
        $sql = "UPDATE tm_curso
    ...
    public function delete_instructor($id_curso)
    {
        $conectar = parent::conexion();
        parent::set_name();
        $sql = "UPDATE tm_curso
    ...
    public function get_instructor_id($id_curso)
    {
        $conectar = parent::conexion();
        parent::set_name();
